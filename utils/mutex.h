...
///
// Changed by Stanislaw Swidwinski <stanislaw.swidwinski@yale.edu>
...
// The role of the guard is to provide RAII-style mutex acquisition.
class MutexRWGuard {
 public:
  MutexRWGuard(MutexRW* m, LockType type) {
    mutex_ = m;
